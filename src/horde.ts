...
export const HORDE_WAVES: HordeWave[] = [
  ...
  { wave: 4, enemies: [{ type: 'zombie', count: 12 }, { type: 'shielder', count: 1 }] },
  { wave: 5, enemies: [{ type: 'zombie', count: 10 }, { type: 'soldier', count: 2 }, { type: 'shielder', count: 1 }] },
  { wave: 6, enemies: [{ type: 'zombie', count: 12 }, { type: 'soldier', count: 4 }, { type: 'shielder', count: 2 }] },
  { wave: 7, enemies: [{ type: 'zombie', count: 15 }, { type: 'soldier', count: 3 }, { type: 'shielder', count: 2 }, { type: 'bomber', count: 1 }] },
  { wave: 8, enemies: [{ type: 'zombie', count: 15 }, { type: 'soldier', count: 3 }, { type: 'sniper', count: 1 }, { type: 'shielder', count: 2 }, { type: 'bomber', count: 1 }] },
  { wave: 9, enemies: [{ type: 'zombie', count: 18 }, { type: 'soldier', count: 3 }, { type: 'sniper', count: 2 }, { type: 'shielder', count: 2 }, { type: 'bomber', count: 2 }] },
  { wave: 10, enemies: [{ type: 'zombie', count: 20 }, { type: 'soldier', count: 3 }, { type: 'sniper', count: 3 }, { type: 'shielder', count: 3 }, { type: 'bomber', count: 2 }] },
  { wave: 11, enemies: [{ type: 'zombie', count: 22 }, { type: 'blade', count: 3 }, { type: 'sniper', count: 2 }, { type: 'soldier', count: 4 }, { type: 'shielder', count: 3 }, { type: 'bomber', count: 2 }] },
  { wave: 12, enemies: [{ type: 'zombie', count: 25 }, { type: 'blade', count: 4 }, { type: 'sniper', count: 3 }, { type: 'soldier', count: 4 }, { type: 'shielder', count: 3 }, { type: 'bomber', count: 2 }] },
