...
export const HORDE_WAVES: HordeWave[] = [
  ...
  { wave: 5, enemies: [{ type: 'blade', count: 2 }, { type: 'zombie', count: 8 }] },
  ...
  { wave: 8, enemies: [{ type: 'blade', count: 3 }, { type: 'zombie', count: 12 }] },
  { wave: 9, enemies: [{ type: 'soldier', count: 3 }, { type: 'blade', count: 2 }, { type: 'zombie', count: 10 }, { type: 'sniper', count: 2 }] },
