...
export const HORDE_WAVES: HordeWave[] = [
  ...
  { wave: 6, enemies: [{ type: 'zombie', count: 12 }, { type: 'soldier', count: 4 }, { type: 'shielder', count: 1 }] },
  { wave: 7, enemies: [{ type: 'zombie', count: 15 }, { type: 'soldier', count: 3 }, { type: 'shielder', count: 1 }, { type: 'bomber', count: 1 }] },
  { wave: 8, enemies: [{ type: 'zombie', count: 15 }, { type: 'soldier', count: 3 }, { type: 'sniper', count: 1 }, { type: 'shielder', count: 1 }, { type: 'bomber', count: 1 }] },
  { wave: 9, enemies: [{ type: 'zombie', count: 18 }, { type: 'soldier', count: 3 }, { type: 'sniper', count: 2 }, { type: 'shielder', count: 1 }, { type: 'bomber', count: 1 }] },
